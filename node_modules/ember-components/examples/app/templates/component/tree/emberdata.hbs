...
If you want a more sophisiticated solution with async support with more control of how children are loaded then look at the {{#link-to 'component.tree.async'}}Async Tree{{/link-to}} approach.
</p>
